            ...
            <form action="" method="post">
                ...
                <div class="content">
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" AutoPostBack="false" Visible="false"/>
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtRepeatPassword" TextMode="Password" runat="server" AutoPostBack="false" Visible="false"/>
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtEmail" TextMode="Email" runat="server" AutoPostBack="false" required/>
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtCode" runat="server" AutoPostBack="false" required/>
