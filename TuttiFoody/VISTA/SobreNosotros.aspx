<%@ Page Title="" Language="C#" MasterPageFile="~/VISTA/SiteMaster.Master" AutoEventWireup="true" CodeBehind="SobreNosotros.aspx.cs" Inherits="TuttiFoody.VISTA.SobreNosotrosM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <section>
            <div class="row">
                <div>
                    <h2 class="text-center primer-h2">QUIENES SOMOS</h2>
                </div>
            ...
            <div class="equipo">
                ...
                <div class="contenido">
                    <div class="col">
                        ...
                        <p>
                            Desde muy pequeño me ha atraído el mundo de la informática y es por eso que elegí hacer un grado medio de sistemas microinformáticos 
                            ...
                            y poder encontrar un empleo donde crecer profesionalmente.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row card">
            <div class="equipo">
                ...
                <div class="contenido">
                    ...
                    <p>
                        Empecé a descubrir el mundo de la programación en el grado de Telecomunicaciones y me embarque en la aventura de realizar un bootcamp de .Net para ampliar
        ...
        <div class="row card">
            <div class="equipo">
                ...
                <div class="contenido">
                    ...
                    <p>
                        ¡Encantado! Soy Taufik un apasionado de la informática que ha completado sus estudios en Desarrollo de Aplicaciones Multiplataforma (DAM) en el Instituto Nicolau Copernico. 
                    ...
                    con mi experiencia y habilidades.
                    </p>
                </div>
            </div>
        ...
        <div class="row card">
            <div class="equipo">
                ...
                <div class="contenido">
                    ...
                    <p>
                        ¡Hola a todos! Después de terminar mi grado superior en creación de videojuegos, estaba ansioso por comenzar mi carrera en la industria. Durante mis estudios, me dediqué en cuerpo y alma a aprender 
                todo lo posible sobre diseño, programación y arte de videojuegos, y trabajé en varios proyectos que me permitieron desarrollar y refinar mis habilidades.
                    </p>
                </div>
            </div>
